...
// LARAVEL ADMIN
Route::group(['middleware' => ['web'], 'prefix' => config('smartycms.route_prefix'), 'namespace' => 'SmartyStudio\SmartyCms\Http\Controllers'], function () {
	...
	// with credentials
	Route::group(['middleware' => [SmartyStudio\SmartyCms\Http\Middleware\AuthenticateAdmin::class]], function () {
...
Route::group(['middleware' => ['web'], 'prefix' => config('smartycms.route_prefix'), 'namespace' => 'App\Http\Controllers'], function () {
	Route::group(['middleware' => [SmartyStudio\SmartyCms\Http\Middleware\AuthenticateAdmin::class]], function () {
		if (File::exists('../routes/cms-routes.php')) {
			require app_path('../routes/cms-routes.php');
		}
	});
});
