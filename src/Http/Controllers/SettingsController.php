...
use SmartyStudio\SmartyCms\Models\Setting;
use SmartyStudio\SmartyCms\Validations\AdminValidation;
use SmartyStudio\SmartyCms\Validations\AdminValidationWithoutPassword;

class SettingsController extends Controller
{
	public function __construct()
	{
		if (config('smartycms.modules.settings') == false) {
			return redirect(config('smartycms.route_prefix'))->with('error', 'Settings module is disabled in config/smartycms.php')->send();
		}
	}
