...
use SmartyStudio\SmartyCms\Models\PageElement;
...
use SmartyStudio\SmartyCms\Validations\PageValidation;
...
class PagesController extends Controller
{
	...
	{
		if (config('smartycms.modules.pages') == false) {
			return redirect(config('smartycms.route_prefix'))->with('error', 'Pages module is disabled in config/smartycms.php')->send();
		}
	}
