        ...
        <td>
            <table style="border-collapse: collapse; width: 100%;font-family: 'dejavu sans', sans-serif;font-size: 11px;">
                ...
                <tr>
                    ...
                    <td style="padding: 0 5px;border: 1px solid black;text-align: right">{{ number_format($order->total_price + $order->total_price * (empty(config('smartycms.invoice.vat')) ? '0' : config('smartycmsinvoice.vat')/100), 2) }} {{ $order->currency }}</td>
                    <td></td>
                </tr>
            </table>
        </td>
