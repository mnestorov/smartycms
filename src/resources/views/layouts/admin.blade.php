...
@section('content')
	<header class="cf">
		<div class="header-top">
			<a href="#" class="logo">
				<img src="{{ (!empty(SmartyStudio\SmartyCms\Models\Setting::first()) && SmartyStudio\SmartyCms\Models\Setting::first()->source != null) ? Storage::url(SmartyStudio\SmartyCms\Models\Setting::first()->source) : 'images/logo.png' }}" alt="SmartyCMS | Admin Logo">
			</a>
		</div>
