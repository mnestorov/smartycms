...
class RestoreCommand extends Command
{
    ...
    protected $name = 'smartycms:restore-database';
     ...
     * @var string
     */
    protected $signature = 'smartycms:restore-database';
    ...
    public function handle() {
        ...
        if (count($migrations) == 0) {
            $this->error('ERROR: No database dumps in: ' . $path);
