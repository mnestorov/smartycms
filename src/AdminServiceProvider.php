...
class AdminServiceProvider extends ServiceProvider
{
    ...
    public function register() {
        ...
        $this->app->singleton('command.smartycms.install', function () {
                return new InstallCommand();
            }
        );

        $this->app->singleton('command.smartycms.update', function () {
                return new UpdateCommand();
            }
        );

        $this->app->singleton('command.smartycms.dump', function () {
                return new DumpCommand();
            }
        );

        $this->app->singleton('command.smartycms.restore', function () {
