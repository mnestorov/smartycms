...
use SmartyStudio\SmartyCms\Models\Location;
use SmartyStudio\SmartyCms\Traits\HelpersTrait;
use SmartyStudio\SmartyCms\Validations\LocationValidation;
...
class LocationsController extends Controller
{
	...
	public function postSave(Request $request)
	{
		...
		$location->key = Str::slug($request->key);
		$location->save();

		return redirect(config('smartycms.route_prefix') . '/places/locations')->with('success', 'Saved successfully');
	}
	...
	public function getDelete($location_id)
	{
		...
		return redirect(config('smartycms.route_prefix') . '/places/locations')->with('success', 'Deleted successfully');
	}
